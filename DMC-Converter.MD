...
- Select between different colour matching algorithms. Each gives a slightly different result. You may want to play around with what the each version produces.
